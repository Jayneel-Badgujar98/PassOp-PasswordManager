...
const Home = () => {
  ...
  return (
    ...
    <div className='nospace text-wrap sticky top-28 text-bold text-[#000] flex justify-end m-7 sm:m-[100px] md:m-[100px]'>Created & Designed With ❤ <span className="font-extrabold text-[#31f031]">&lt;PassOP /&gt;</span> <i className='text-md'>by Jay Badgujar</i></div>
